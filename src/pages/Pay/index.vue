  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-info">
        <h4>重要说明：</h4>
        <ol>
          <li>开心淘商城支付平台目前支持<span class="zfb">微信支付</span>。</li>
          <li>其它支付渠道正在调试中，敬请期待。</li>
          <li>为了保证您的购物支付流程顺利完成，请仔细阅读。</li>
        </ol>
        <!-- <h4>
      ...
      <div class="checkout-steps">
        ...
        <div class="step-cont">
          <ul class="payType">
            ...
            <li style="border: 1px solid #e1251b">
...
export default {
  ...
  methods: {
    ...
    async open() {
      ...
      // 弹出框的配置
      this.$alert(`<img src=${url} />`, '请您微信扫码支付', {
      ...
      if (!this.timer) {
        this.timer = setInterval(async () => {
          // 发请求获取用户支付状态(带参数 orderId)
          let result = await this.$API.reqPayStatus(this.orderId)
          // console.log(result)
          // 如果code=200，代表支付成功，清定时器
          if (result.code == 200) {
            // 第一步：清定时器
            clearInterval(this.timer)
            this.timer = null
